...
public class TestActivityHandler extends ActivityInstrumentationTestCase2<UnitTestActivity> {
    ...
    public void testDisable() {
        ...
        startActivity(activityHandler,
                true,   // checkLog
                false,   // foregroundTimerStarts
                false); // foregroundTimerAlreadyStarted
...
*/
    ...
    private void checkEndSession(boolean updateActivityState) {
        checkEndSession(true, updateActivityState, false);
    }

    private void checkEndSession(boolean pausing, boolean updateActivityState, boolean eventBufferingEnabled) {
        if (pausing) {
    ...
    private void startActivity(ActivityHandler activityHandler) {
        startActivity(activityHandler, true);
    }

    private void startActivity(ActivityHandler activityHandler, boolean checkLog) {
        startActivity(activityHandler, checkLog, true, false);
    }

    private void startActivity(ActivityHandler activityHandler,
                               boolean checkLog,
                               boolean foregroundTimerStarts,
                               boolean foregroundTimerAlreadyStarted) {
        // start activity
        activityHandler.onResume();
        ...
        if (checkLog) {
            ...
            // start foreground timer
            if (foregroundTimerStarts) {
                if (foregroundTimerAlreadyStarted) {
    ...
    private void stopActivity(ActivityHandler activityHandler) {
        stopActivity(activityHandler, false, false, false);
    }
