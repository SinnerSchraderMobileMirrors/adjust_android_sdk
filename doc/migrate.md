## Migrate your adjust SDK for Android to 3.5.1 from v2.1.x
...
5. Download version v3.5.1 and create a new Android project from the `Adjust` folder.
...
The adjust SDK v3.5.1 added delegate notifications. Check out the [README] for
details.
